<?php
	...
	{
		$error="";
		$msg="<br><span class=msg>Reserve Bed Added Successfully</span><br><br>";
...
?>
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	<li><a href="rbeds.php">VIew All Reserve Beds</a></li>
                    	<li><a href="add-rbed.php" class="active">Add New Reserve Bed</a></li>
                    </ul>
                    <!-- // .sideNav -->
                </div>    
                <!-- // #sidebar -->
                ...
                <form method="post" >
                    ...
                    <?php
						if(isset($_POST['save']))
						{
							...
							{
								mysqli_query($server,"INSERT INTO rbeds (type,ward) VALUES ('$type','$ward')");
								echo $msg;
							}
